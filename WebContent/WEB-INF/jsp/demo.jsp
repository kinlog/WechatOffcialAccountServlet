...
<%@ page language="java" import="java.util.*,com.wechat.constants.*,com.wechat.utils.*,com.wechat.service.*"
	contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<%@ taglib uri="/WEB-INF/taglib/c-1_0-rt.tld" prefix="c"%>
<!DOCTYPE html>
<!-- saved from url=(0039)http://203.195.235.76/jssdk/#menu-smart -->
...
<div class="wxapi_container">
    <div class="wxapi_index_container">
      <ul class="label_box lbox_close wxapi_index_list">
        ...
        <li class="label_item wxapi_index_item"><a class="label_inner" >智能接口</a></li>
  ...
  <input id="pagehref" type="hidden" value="window.location.href">
...
<script>
   ...
   */
	...
	<%  long time = System.currentTimeMillis() / 1000; 
		String pageUrl = "http://newkinglong.duapp.com/SimpleServlet/control/pages/demo";%>
  wx.config({
      debug: true,
      appId: '<%=WeChatAccount.APPID%>',
      timestamp: '<%=time%>',
      nonceStr: 'uT2hvUKvmphvUtWc',
      signature: '<%=SignCheck.getSignature(JsApiTicketService.getJsApiTicket(), String.valueOf(time), "uT2hvUKvmphvUtWc", pageUrl)%>',
      jsApiList: [
        'checkJsApi',
        'onMenuShareTimeline',
